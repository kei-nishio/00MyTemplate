...
<div class="p-form">
  <dl class="p-form__list">
    ...
    <div class="p-form__item">
      ...
      <dd class="p-form__description">[select* your-select id:f-select data:custom-select]</dd>
    </div>
    <!-- * Select 条件分岐がある場合 -->
    <div class="p-form__item">
      [group quotation clear_on_hide]
      <dt class="p-form__term">
        <label for="f-select">
          お問い合わせの種類（セレクト）
          <sup class="p-form__required">*</sup>
    ...
    <div class="p-form__item">
      ...
      <dd class="p-form__description">[textarea* your-message id:f-textarea]</dd>
    </div>
    <!-- * zip-code -->
    <div class="p-form__item">
      <dt class="p-form__term">
      ...
      <dd class="p-form__description">[text* your-zip-code id:f-zip-code placeholder "例）123-4567"]</dd>
    </div>
    <!-- * address -->
    <div class="p-form__item">
      <dt class="p-form__term">
      ...
      <dd class="p-form__description">[text* your-address id:f-address placeholder "例）京都府京都市中京区○○"]</dd>
    </div>
  </dl>
  <!-- * Acceptance -->
  <div class="p-form__policy">
    [acceptance your-acceptance]
    <a href="/privacy-policy/" target="_blank" rel="noreferrer noopener">「個人情報の取り扱いについて」(プライバシーポリシー)</a>に 同意する [/acceptance]
  </div>
