...
function my_script_init()
{
  ...
  wp_enqueue_script('inview', get_theme_file_uri('/assets/js/jquery.inview.min.js'), array('jquery', 'swiper', 'gsap', 'gsap-scroll-trigger'), "10.0", true);
  wp_enqueue_script('script-main', get_theme_file_uri('/assets/js/script.js'), array('jquery', 'swiper', 'gsap', 'gsap-scroll-trigger', 'inview'), '1.0.0', true);
}
